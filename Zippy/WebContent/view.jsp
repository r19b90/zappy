				...
				<table class="table table-condensed">
					<thead>
						...
						<tr class="cart_menu">
							...
							<td class="description">Descritption</td>
							<td></td>
							<td></td>
					...
					{%>
						<tr><form action="Updateproduct.jsp" method="post">
							<td class="image">
						   	<%String iname= e.getImage(); %>
 						   	<img src="images\<%=iname%>" heigth="100" width="100"/>
							</td>
							<td class="id">
							<%= e.getProductID()%> <input type="hidden" value="<%= e.getProductID()%>" name="pid" />
							</td>
							<td class="name">
							<%= e.getName()%> <input type="hidden" value="<%= e.getName()%>" name="pname" />
							</td>
							
							<td class="price">
							<%= e.getPrice()%><input type="hidden" value="<%= e.getPrice()%>" name="price" /> 
								
							</td>
							<td class="description">
							<%= e.getDescription()%><input type="hidden" value="<%= e.getDescription()%>" name="desc" />
							</td>
							<td class="update">
