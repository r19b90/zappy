...
<body>
	...
	<section id="cart_items">
		<div class="container">
			...
			<% MyDao m = new MyDao();
		ArrayList<CustomerBean> list = m.viewcart();%>
				<table class="table table-condensed">
					...
					{%>
						<tr><form action="./Cartdelete" method="get">
						   ...
						   <%= e.getProductID()%> <input type="hidden" value="<%= e.getProductID()%>" name="pid" />
							...
							<%= e.getQuantity() %><input type="hidden" value="<%= e.getQuantity()%>" name="qty"/>
							</td>
