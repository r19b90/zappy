					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="shop.jsp">Shop</i></a></li> 
		...
		<div class="container">
			...
			<div class="table-responsive cart_info">
					...
					<tbody>
						<tr>
							<td class="product">
						  <a href="Addproduct.jsp">1. Add Product</a>
							</td>
							<td class="details">
							<a href="view.jsp">2. View Product details</a>
							</td>
							<td class="registered">
							4. View Registered Customer
							</td>
							
							<td class="order">
							5. View the current order placed  by customer with payment details
								
							</td>
							<td class="dispatch">
							6. Dispatch the order and change status of all pending orders
							</td>
							<td class="viewhistory">
							7. View the order history</td>
